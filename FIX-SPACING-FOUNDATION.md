...
Fase 0 del rediseño: se corrigieron los defectos de espaciado objetivo del capability book sin rediseñar covers, gateway raíz ni composición del hero. Se estableció una métrica de espaciado coherente (escala 4px + tokens semánticos), se normalizaron los controles interactivos a 44px mínimos y se añadió validación automática de variables CSS en CI.
